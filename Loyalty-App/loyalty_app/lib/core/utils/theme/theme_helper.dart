...
class ThemeHelper {
  ...
  ThemeData _getThemeData() {
    ...
    return ThemeData(
      ...
      primarySwatch: _createMaterialColor(appTheme.deepOrange800),
      ...
      sliderTheme: SliderThemeData(
        activeTrackColor: appTheme.deepOrange800,
        inactiveTrackColor: appTheme.deepOrange800.withOpacity(0.3),
        thumbColor: appTheme.deepOrange800,
        overlayColor: appTheme.deepOrange800.withOpacity(0.2),
        valueIndicatorColor: appTheme.deepOrange800,
      ),
      textSelectionTheme: TextSelectionThemeData(
        cursorColor: appTheme.deepOrange800,
        selectionColor: appTheme.deepOrange800.withOpacity(0.5),
        selectionHandleColor: appTheme.deepOrange800,
      ),
    );
  }

...
class _ScanCodeScreenRefState extends State<ScanCodeScreenRef>
  ...
  Future<void> _saveBarcodeToLocalDatabase(
  ...
  Future<Uint8List> _simulateBarcodeGeneration(String barcodeValue) async {
    ...
    return Uint8List.fromList(
        base64.decode(simulatedQRCodeDataUri.split(',')[1]));
  }
  ...
  Future<void> fetchBarcodeStatus(int barcodeId) async {
    try {
      if (barcodeId != null) {
        bool isBarcodeRead =
            await BarcodeController().getBarcodeIsRead(barcodeId);
                      ...
                      children: [
                        Align(
                          ...
                          child: Text(
                            "msg51".tr,
                            style:
                                CustomTextStyles.titleSmallBahijTheSansArabic15,
                          ),
                        ),
                        Padding(
                          ...
                          builder: (context, snapshot) {
                            if (snapshot.connectionState ==
                              ...
                              if (barcodeData != null) {
                                ...
                                final Uint8List? qrCodeImageBytes =
                                    barcodeData['qrCodeImageBytes'];
                                ...
                                if (qrCodeImageBytes != null) {
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: FutureBuilder<
                                          ...
                                          future: BarcodeController()
                                              .getBarcodeByStoreAndOfferId(
                                                  storeId!, offerId!),
                                          builder: (context, snapshot) {
                                            if (snapshot.connectionState ==
                                                ConnectionState.waiting) {
                                              ...
                                              if (snapshot.hasData &&
                                                ...
                                                String? barcodeValue = snapshot
                                                    .data![0]['barcode_value'];
                                                if (barcodeValue != null) {
                                                  int startIndex =
                                                      barcodeValue.indexOf("#");
                                                  int endIndex =
                                                      barcodeValue.indexOf(
                                                          "#", startIndex + 1);
                                                  if (startIndex >= 0 &&
                                  ...
                                  return const Text(
                                      'Error: Failed to load barcode image');
                                }
                              } else {
                                return const CircularProgressIndicator();
                              }
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: Text(
                              ...
                              style: CustomTextStyles
                                  .titleSmallBahijTheSansArabic_1,
                            ),
                          ),
                        ),
                        Padding(
                        ...
                        FutureBuilder<List<Map<String, dynamic>>>(
                          future: BarcodeController()
                              .getBarcodeByStoreAndOfferId(storeId!, offerId!),
                          builder: (context, snapshot) {
                            if (snapshot.connectionState ==
                                ConnectionState.waiting) {
                              return const CircularProgressIndicator();
                              ...
                              if (barcodes != null && barcodes.isNotEmpty) {
                                  ...
                                  if (offers != null) {
                                    ...
                                    if (pointsRedeemed != null) {
                                      Provider.of<UserProfileModel>(context,
                                              listen: false)
                                          .updateTotalPointsRedeemed(
                                              pointsRedeemed);
                                      Provider.of<UserProfileModel>(context,
                                              listen: false)
                                          .updateTotalPoints(pointsRedeemed);
                                    } else {
                                      if (kDebugMode) {
                                        print(
                                            'Number of points redeemed is null');
                                      }
                                    }
                                  } else {
                                    if (kDebugMode) {
                                ...
                                return CustomElevatedButton(
                                  height: 32.v,
                                  width: 190.h,
                                  text: barcodeStatus == 'redeemed'
                                      ? 'lbl53'.tr
                                      : 'msg54'.tr,
                                  margin:
                                      EdgeInsets.only(left: 100.h, top: 6.v),
...
class ReplacePointListClothes extends StatelessWidget {
  ...
  const ReplacePointListClothes({Key? key, this.offerId, this.storeId})
      : super(key: key);

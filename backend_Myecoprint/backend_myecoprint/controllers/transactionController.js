...
exports.getTransactionWeekly = async (req, res) => {
  try {
    ...
    // Adjust to get the start and end dates for the current week
    const startDate = moment().startOf('week').toDate(); // Sunday
    const endDate = moment().endOf('week').toDate(); // Saturday

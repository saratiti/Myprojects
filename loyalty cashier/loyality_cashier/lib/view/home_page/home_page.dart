...
import 'package:loyality_cashier/controller/loyalty.dart';
import 'package:loyality_cashier/core/routes/app_routes.dart';
import 'package:loyality_cashier/view/home_page/widgets/slider_item_widget.dart';
import 'package:loyality_cashier/view/navigation/navigation.dart';
...
Widget _buildAppBar(BuildContext context) {
  ...
  onTap: () {
    Navigator.pushNamed(context, AppRoutes.generetedQr);
  },
),
  ...
  text: 'Scan Barcode',
  onTap: () {
    Navigator.pushNamed(context, AppRoutes.scannerScreen);
  },
),
